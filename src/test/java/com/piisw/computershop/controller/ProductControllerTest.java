...
public class ProductControllerTest {
	...
	public void shouldReturnTwoProducts() throws Exception {
		...
		ProductResponseDTO dto1 = new ProductResponseDTO(1L, "NVIDIA GeForce GTX 1050 Ti", new BigDecimal("189.99"), "Graphics cards", 1L, mainAttributesDtos1, additionalAttributesDtos1, "Description8");
		...
		ProductResponseDTO dto2 = new ProductResponseDTO(2L, "AMD Radeon RX 590", new BigDecimal("239.99"), "Graphics cards", 2L, mainAttributesDtos2, additionalAttributesDtos2, "Description9");
	...
	public void shouldReturnProductsForGivenCategory() throws Exception {
		...
		ProductResponseDTO dto1 = new ProductResponseDTO(1L, "NVIDIA GeForce GTX 1050 Ti", new BigDecimal("189.99"), "Graphics cards", 1L, mainAttributes, additionalAttributes, "Description10");
	...
	public void shouldReturnProduct() throws Exception {
		...
		ProductResponseDTO dto = new ProductResponseDTO(1L, "NVIDIA GeForce GTX 1050 Ti", new BigDecimal("189.99"), "Graphics cards", 1L, mainAttributes, additionalAttributes, "Description11");
	...
	public void shouldNotReturnProduct() throws Exception {
		...
		ProductResponseDTO dto = new ProductResponseDTO(1L, "NVIDIA GeForce GTX 1050 Ti", new BigDecimal("189.99"), "Graphics cards", 1L, mainAttributes, additionalAttributes, "Description12");
